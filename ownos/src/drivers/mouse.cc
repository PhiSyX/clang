...
void MouseEventHandler::on_activate() const
{
}

void MouseEventHandler::on_mousedown(u8 button) const
{
}

void MouseEventHandler::on_mouseup(u8 button) const
{
}

void MouseEventHandler::on_mousemove(i32 x, i32 y) const
{
}

MouseDriver::MouseDriver(InterruptManager *input_manager,
                         MouseEventHandler *$handler)
    : InterruptHandler(input_manager, 0x2C), data_port(0x60), command_port(0x64)
{
    handler = $handler;
}
