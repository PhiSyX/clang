...
VGA::VGA()
    : misc_port(0x3c2), crtc_index_port(0x3d4), crtc_data_port(0x3d5), sequencer_index_port(0x3c4), sequencer_data_port(0x3c5), graphics_controller_index_port(0x3ce), graphics_controller_data_port(0x3cf), attribute_controller_index_port(0x3c0), attribute_controller_read_port(0x3c1), attribute_controller_write_port(0x3c0), attribute_controller_reset_port(0x3da)
{
}

VGA::~VGA() {}

void VGA::write_registers(u8 *registers)
{
...
bool VGA::set_mode(const u32 width, const u32 height, const u32 colordepth)
{
...
u8 *VGA::get_frame_buffer_segment()
{
...
void VGA::put_pixel(const i32 x, const i32 y, const u8 color_index)
{
...
void VGA::put_pixel(const i32 x, const i32 y, const u8 r, const u8 g, const u8 b)
{
    put_pixel(x, y, get_color_index(r, g, b));
}

void VGA::fill_rect(const u32 $x,
                    const u32 $y,
                    const u32 width,
                    const u32 height,
                    const u8 r,
